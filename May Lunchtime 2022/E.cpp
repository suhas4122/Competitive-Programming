...
//     mark_sum[0] = mark[0];
//     for (int i = 1; i < n; i++) {
//         mark_sum[i] = mark_sum[i - 1] + mark[i];
//     }
//     for0(q) {
//         ll l, r;
//         cin >> l >> r;
//         l--, r--;
//         ll ans = 0;
//         ans += mark_sum[r] - (l > 0 ? mark_sum[l - 1] : 0);
//         if(mark[l] != 1) ans++;
...
//         pr(temp);
//         curr = temp[0];
//         for (ll i = 1; i < sz(temp); i++) {
//             if (curr.se < temp[i].fi) {
//                 curr = temp[i];
//             } else if(curr.se < temp[i].se) {
//                 ans += 2;
//                 curr = temp[i];
//             } else {
//                 ans++;
