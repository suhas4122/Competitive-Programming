...
ll counter(ll n, string s){
    ll count = 0, flag1 = 0, flag2;
    ll last;
    for0(n){
        if(flag1 == 0 && s[i] != 'F'){
            flag1 = 1;
            flag2 = (s[i] == 'O') ? 1 : 0;
            last = i;
        }else if(flag1 && s[i] == 'O' && flag2 == 0){
            ll add = (last + 1) * (n - i);
            count = modA(count, add);
            last = i;
            flag2 = 1;
        }else if(flag1 && s[i] == 'X' && flag2 == 1){
            ll add = (last + 1) * (n - i);
            count = modA(count, add);
            last = i;
            flag2 = 0;
        }else if(flag1 && s[i] == 'O' && flag2 == 1){
            last = i;
        }else if(flag1 && s[i] == 'X' && flag2 == 0){
            last = i;
        }
    }
