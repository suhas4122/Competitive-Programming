...
//     cin >> n;
//     vll a(n);
//     ll minpos = 1e18, maxneg = -1e18, zero = 0;
//     for0(n) {
//         cin >> a[i];
//         if(a[i] < 0) maxneg = max(maxneg, a[i]);
//         else if(a[i] > 0) minpos = min(minpos, a[i]);
//         else zero = 1;
//     }

//     auto change = [&] (ll tar) -> ll {
//         ll ans = 0;
//         for(int i = 0; i < n; i++) {
//             ll change = abs(tar - a[i]);
//             if(i == 0 || i == n - 1) {
//                 if(a[i] >= tar) {
//                     ans += change;
//                 } else {
...
//     ll ans1, ans2, ans3;
//     ans1 = ans2 = ans3 = 1e18;
//     if(minpos != 1e18) ans1 = change(minpos);
//     if(maxneg != -1e18) ans2 = change(maxneg);
//     ans3 = change(0);
...
void solve() {
    ...
    ll mini2 = 1e18;
    for0(n) {
        mini2 = min(a[i] - mini, mini2);
        vals[i] = a[i] - mini - mini2;
    }    
