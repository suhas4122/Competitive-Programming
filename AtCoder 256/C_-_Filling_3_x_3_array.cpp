...
void solve() {
    ...
    ll ans = 0;
    for(int i1 = 0; i1 <= min(w[0], h[0]); i1 ++) {
        for(int i2 = 0; i2 <= min(w[1], h[0] - i1); i2++) {
            for(int j1 = 0; j1 <= min(w[0] - i1, h[1]); j1++) {
                for(int j2 = 0; j2 <= min(w[1] - i2, h[1] - j1); j2++) {
                    int i3 = h[0] - i1 - i2;
                    int j3 = h[1] - j1 - j2;
                    int k1 = w[0] - i1 - j1;
                    int k2 = w[1] - i2 - j2;
                    int k3 = w[2] - i3 - j3;
                    if(k1 >= 0 && k2 >= 0 && k3 >= 0 && k1 + k2 + k3 == h[2]) {
                        ans++;
                    }
                }
            }
